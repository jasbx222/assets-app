      ...
      <Stack direction="row" spacing={3}>
        <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
          ...
          <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
            ...
            <Button color="inherit" startIcon={<DownloadIcon style={{ margin:'5px'}}  fontSize="var(--icon-fontSize-md)" />}>
              تصدير
            </Button>
          </Stack>
        </Stack>
        <div>
          <Button style={{
              margin:'10px'
          }} startIcon={<PlusIcon fontSize="var(--icon-fontSize-md)" style={{ margin:'5px'}} />} variant="contained">
            اضافة
          </Button>
        </div>
      </Stack>
